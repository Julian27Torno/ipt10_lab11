...
use Fpdf\Fpdf; // Ensure you have the FPDF library included
...
class CourseController extends BaseController
{
    ...
    public function list()
    {
        ...
        // Calculate the number of enrollees for each course
    ...
    // View specific course details and enrollees
    ...
    // Export course enrollees to PDF
    public function exportCourseEnrollees($course_code)
{
    ...
    foreach ($enrollees as $enrollee) {
        ...
        $pdf->Cell(70, 10, $enrollee->name, 1);  // Make sure name is correctly populated
        $pdf->Cell(50, 10, $enrollee->enrolment_date, 1);  // Ensure correct spelling
        $pdf->Ln();
    }
